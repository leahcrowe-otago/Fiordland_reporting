...
multiplot <- function(dolphin_name){
  ...
  cat(
    glue::glue("\n ID code: {lh_dolphin$CODE} | sex: {lh_dolphin$SEX} | age: {lh_dolphin$LASTYEAR_AGE} |  mom: {lh_dolphin$MOM}  | birth yr: {lh_dolphin$BIRTH_YEAR} |  first yr: {lh_dolphin$FIRST_YEAR} | last yr: 
    \n calves: {calves_sent}")
  )
...
if (area == "Dusky"){
  ...
  if (dolphin_name == "PEANUT"){
    cat("\n\\newpage\n")
  }
  
  if (dolphin_name == "RHODES"){
    cat("\n\\newpage\n")
  }  

    if (dolphin_name == "BLANK"){
    cat("\n\\newpage\n")
  }
  
    if (dolphin_name == "COMMON"){
    cat("\n\\newpage\n")
  }
      
  if (dolphin_name == "NESS"){
    cat("\n\\newpage\n")
      }
  
  if (dolphin_name == "OYSTER"){
    cat("\n\\newpage\n")
  }
    if (dolphin_name == "SCOOP"){
    cat("\n\\newpage\n")
  }
...
if (area == "Doubtful"){  
  ...
  if (dolphin_name == "CHIP"){
    cat("\n\\newpage\n")
  }

  if (dolphin_name == "DANGER"){
    cat("\n\\newpage\n")
  }
