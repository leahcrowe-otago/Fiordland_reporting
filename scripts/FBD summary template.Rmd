...
```
\vspace*{-1mm}
Fig. 1. Maps of survey effort (a) and dolphins sightings (b) during this research effort. a) Initial bottlenose dolphin sighting locations are indicated by the red diamonds, and the colored lines represent periods of the survey spent with the dolphins. 
\newpage
\vspace*{5mm}
\vspace*{-5mm}
...
knitr::kable(params$unseen_table%>%dplyr::select(LAST_YEAR, AgeClass, F, M, X), "latex", booktabs = T, linesep = "", escape = F, caption = paste0("Age class and sex structure of individuals from the ", pharea, " pod that have not been sighted in the last year (since ",recent, "), but were sighted in the year before (between ", older, " and ", recent,"). See Table 1 for age class definitions."), col.names = c("Last year sighted","Age class","Female","Male","Unknown"))%>%
   kable_styling(latex_options = c("HOLD_position"), full_width = F)%>%
