...
\vspace*{-1mm}
\rule[\baselineskip]{\linewidth}{0.4pt}\vspace{-6mm}
Total time with dolphins within 100 m (hours): \hfill `r params$hours_wTt$total_wTt`
\vspace*{-1mm}
\rule[\baselineskip]{\linewidth}{0.4pt}\vspace{-6mm}
...
```
\vspace*{-10mm}
Fig. 2. Number of animals sighted on each survey day (vertical bars), and the discovery curve of new individuals identified over the survey period (black circles and lines). 
