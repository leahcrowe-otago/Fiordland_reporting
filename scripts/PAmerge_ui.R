fluidPage(  
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("otherfiord","Other fiords surveyed:", c("Charles" = "Taiporoporo-Charles Sound",
                                                           "Nancy" = "Hinenui-Nancy Sound",
                                                           "Dagg" = "Te R\u101-Dagg Sound",
                                                           "Chalky" = "Taiari-Chalky Inlet",
                                                           "Preservation" = "Rakituma-Preservation Inlet"), multiple = T),
